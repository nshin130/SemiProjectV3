...
import nshin.spring.mvc.service.MemberService;
...
public class JoinController {
    ...
    // 스프링의 ViewResolver없이 바로 응답을 출력할 수 있음
    // 결과는 자바스크립트의 ajax를 이용해 적절히 가공해서 폼에 출력
    @ResponseBody
    ...
    public String login(Member m, HttpSession sess) {
        ...
        if (msrv.checkLogin(m,sess)) // successfully logged in
            returnPage = "redirect:/";
