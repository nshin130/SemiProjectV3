    ...
    <form name="joinfrm" id="joinfrm">
        <div class="row">
            ...
            <div class="form-group row">
                ...
                <input type="text" class="col-2 form-control  border-danger" readonly value=${param.name} name="name" id="name">
            </div><!--이름-->

            <div class="form-group row">
                <label for="jumin1" class="col-2 text-right text-danger col-form-label">주민등록번호</label>
                <input type="text" class="border-danger form-control col-2" name="jumin1" id="jumin1" readonly value="${param.jumin1}">
                <span class="col-form-label">&nbsp;&#45;&nbsp;</span>
                <input type="password" class="border-danger form-control col-2" name="jumin2" id="jumin2" readonly value="${param.jumin2}">
            </div><!--주민번호-->
            ...
            <div class="form-group row">
                ...
                <span id="uidmsg" class="col-form-label"><small class="text muted">&nbsp; 8~16자의 영문 소문자,숫자와 특수기호&#40;&#95;&#41; 만 사용할 수 있습니다.</small></span>
            </div><!--아이디-->

            <div class="form-group row">
                <label for="passwd" class="text-danger col-form-label col-2 text-right">비밀번호</label>
                <input type="password" name="passwd" id="passwd" class="border-danger form-control col-3">
                <span class="col-form-label" id="pwdmsg1"><small class="text muted">&nbsp; 8~16 자의 영문 대소문자&#44;숫자 및 특수문자 사용할 수 있습니다.</small></span>
            </div><!--비번-->
            ...
            <div class="form-group row">
                ...
                <span class="col-form-label" id="pwdmsg"><small class="text muted">&nbsp; 이전 항목에서 입력했던 비밀번호를 한번 더 입력하세요.</small></span>
            </div><!--비번확인-->

            <div class="form-group row">
                <label for="zip1" class="text-right text-danger col-form-label col-2" >우편번호</label>
                ...
                <button type="button" id="zipcodebtn" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#zipmodal"><i class="fas fa-question-circle"></i> 우편번호 찾기</button>
            </div><!--우편번호-->
            ...
            <div class="form-group row">
            <label class="text-danger text-right col-form-control col-2">자동가입방지</label>
      ...
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-danger btn-sm" id="sendzip"><i class="fas fa-check-circle"></i> 선택하고 닫기</button>
              </div>
          </div>
      </div>
  </div>
